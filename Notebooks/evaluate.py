...
train_ds = keras.utils.image_dataset_from_directory(
    directory='/home/lucien/Documents/projet_abeilles/abeilles-cap500/cap500/train_cap_andrena/',
    labels='inferred',
...
model.load_weights('/home/acarlier/Desktop/model_crop_andrena/model')#mettre ici le même chemin que celui des callbacks (dans la var model_checkpoints)
...
test_ds = keras.utils.image_dataset_from_directory(
    directory='/home/lucien/Documents/projet_abeilles/abeilles-cap500/cap500/test_cap_andrena/',
    labels='inferred',
    label_mode='categorical',
    batch_size=16,
    image_size=(IMG_SIZE, IMG_SIZE))
...
x_test = np.zeros((552, IMG_SIZE, IMG_SIZE, 3))#sinon 1832
y_test = np.zeros((552, nb_classes))
