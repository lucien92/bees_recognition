...
train_ds = tf.keras.utils.image_dataset_from_directory(
    directory='/home/lucien/Documents/projet_abeilles/abeilles-cap500/cap500/train',
    labels='inferred',
...
validation_ds = keras.utils.image_dataset_from_directory(
    directory='/home/lucien/Documents/projet_abeilles/abeilles-cap500/cap500/val/',
    labels='inferred',
    label_mode='categorical',
    batch_size=16,
    image_size=(IMG_SIZE, IMG_SIZE))
...
y_train = np.zeros((18898, nb_classes))#rentrer la taille du train
...
x_val = np.zeros((2361, IMG_SIZE, IMG_SIZE, 3))#rentrer la taille du valval
y_val = np.zeros((2361, nb_classes))#rentrer la taille du val
...
hierarchie = pd.read_csv("/home/lucien/Documents/projet_abeilles/abeilles-cap500/csv/hierarchie_especes71.csv")
...
data = pd.read_csv("/home/lucien/Documents/projet_abeilles/abeilles-cap500/csv/liste_classes_71.csv")
...
model_checkpoint_cb = tf.keras.callbacks.ModelCheckpoint(
    filepath='/home/acarlier/Desktop/model_non_crop/model', 
